...
\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{codes=som_model}\OperatorTok{$}\NormalTok{codes[[}\DecValTok{1}\NormalTok{]]}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{10}\NormalTok{)\{}
\KeywordTok{plot}\NormalTok{(som_model, }\DataTypeTok{type =} \StringTok{"property"}\NormalTok{, }\DataTypeTok{property =}\NormalTok{ codes[,i}\DecValTok{-1}\NormalTok{], }\DataTypeTok{main=}\KeywordTok{names}\NormalTok{(protein)[i])}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-51-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data <-}\StringTok{ }\NormalTok{som_model}\OperatorTok{$}\NormalTok{codes[[}\DecValTok{1}\NormalTok{]]}
...
\NormalTok{\}}
\KeywordTok{plot}\NormalTok{(wss, }\DataTypeTok{type =} \StringTok{"o"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-52-1.pdf}

Use hierarchical clustering to cluster the codebook vectors with 6 clusters.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{som_cluster <-}\StringTok{ }\KeywordTok{cutree}\NormalTok{(}\KeywordTok{hclust}\NormalTok{(}\KeywordTok{dist}\NormalTok{(som_model}\OperatorTok{$}\NormalTok{codes[[}\DecValTok{1}\NormalTok{]])), }\DecValTok{6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(som_model, }\DataTypeTok{type=}\StringTok{"mapping"}\NormalTok{, }\DataTypeTok{labels=}\NormalTok{protein}\OperatorTok{$}\NormalTok{Country, }
     \DataTypeTok{main =} \StringTok{"Clusters"}\NormalTok{, }\DataTypeTok{cex =} \FloatTok{.5}\NormalTok{) }
\KeywordTok{add.cluster.boundaries}\NormalTok{(som_model, som_cluster)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-54-1.pdf}

add background colors to units according to their predicted class labels

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pretty_palette <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"#1f77b4"}\NormalTok{, }\StringTok{'#ff7f0e'}\NormalTok{, }\StringTok{'#2ca02c'}\NormalTok{, }\StringTok{'#d62728'}\NormalTok{, }\StringTok{'#9467bd'}\NormalTok{, }\StringTok{'#8c564b'}\NormalTok{, }\StringTok{'#e377c2'}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(som_model, }\DataTypeTok{type=}\StringTok{"quality"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-55-2.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(som_model, }\DataTypeTok{type=}\StringTok{"mapping"}\NormalTok{, }\DataTypeTok{labels=}\NormalTok{protein}\OperatorTok{$}\NormalTok{Country, }
     \DataTypeTok{bgcol =}\NormalTok{ pretty_palette[som_cluster], }\DataTypeTok{cex=}\NormalTok{.}\DecValTok{8}\NormalTok{)}

\NormalTok{som_model}\OperatorTok{$}\NormalTok{unit.classif}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##  [1]  4 16 15  4 12 13 16 13 10  2  8 15  2 16 13 12  5  3  1 13 11 10  8 16  3
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{som.hc <-}\StringTok{ }\KeywordTok{cutree}\NormalTok{(}\KeywordTok{hclust}\NormalTok{(}\KeywordTok{dist}\NormalTok{(som_model}\OperatorTok{$}\NormalTok{codes[[}\DecValTok{1}\NormalTok{]])), }\DecValTok{6}\NormalTok{)}
\KeywordTok{add.cluster.boundaries}\NormalTok{(som_model, som.hc)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Unsupervised-Learning_files/figure-latex/unnamed-chunk-55-3.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# get vector with cluster value for each original data sample}
\NormalTok{cluster_assignment <-}\StringTok{ }\NormalTok{som.hc[som_model}\OperatorTok{$}\NormalTok{unit.classif]}
\CommentTok{# for each of analysis, add the assignment as a column in the original data:}
\NormalTok{protein}\OperatorTok{$}\NormalTok{cluster <-}\StringTok{ }\NormalTok{cluster_assignment}
\NormalTok{protein}\OperatorTok{$}\NormalTok{whichnode <-}\StringTok{ }\NormalTok{som_model}\OperatorTok{$}\NormalTok{unit.classif}
\KeywordTok{head}\NormalTok{(protein[,}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{11}\NormalTok{)],}\DecValTok{20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
